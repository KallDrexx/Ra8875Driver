...
public class Octahedron {
    public void Run(Ra8875 ra8875) {
        ...
        while(true) {
            ra8875.DrawRect(0, 0, 800, 480, Color.Black, true);
            ...
            foreach (var triangle in rotatedOctehedron) {
                ...
                if (normal.Z > 0) {
                    ...
                    // Console.WriteLine($"Projected triangle: ({x0}, {y0}), ({x1}, {y1}), ({x2}, {y2})");
                    
                    ra8875.DrawTriangle(x0, y0, x1, y1, x2, y2, color, true);
                }
            }
